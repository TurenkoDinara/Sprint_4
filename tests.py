...
class TestBooksCollector:
    ...
    # 1) позитивная проверка на метод add_new_book
    ...
    # 2) негативная проверка на метод set_book_genre
    ...
    # 2) позитивная проверка на метод set_book_genre
    ...
    # 3) негативная проверка на метод get_book_genre
    ...
    # 4) позитивная проверка на метод get_books_with_specific_genre
    ...
    # 5) позитивная проверка на метод get_books_genre
    ...
    # 6) позитивная проверка на метод get_books_for_children
    ...
    # 6) негативная проверка на метод get_books_for_children
    ...
    # 7) позитивная проверка на метод add_book_in_favorites
    ...
    # 7) негативная проверка на метод add_book_in_favorites
    ...
    # 8) позитивная проверка на метод delete_book_from_favorites
    ...
    # 8) негативная проверка на метод delete_book_from_favorites
    ...
    # 9) позитивная проверка на метод get_list_of_favorites_books
